# Домашнее задание к занятию "`Система мониторинга Zabbix. Часть 2`" - `Скворцов Александр`
...
![Созданный шаблон](img/6.png)

![Созданные элементы-данных](img/7.png)
...
![Скриншот кастомного дашборда](img/11.png)
