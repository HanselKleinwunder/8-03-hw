...
**Ссылка на файл сканирования:**

[Результаты сканирования Nmap](nmap/nmap_scan_results.txt)
...
1. [Файлы wireshark](nmap/wireshark/)

2. [Ссылка на fin_scan.txt](nmap/fin_scan.txt)

3. [Ссылка на syn_scan.txt](nmap/syn_scan.txt)

4. [Ссылка на xmas_scan.txt](nmap/xmas_scan.txt)

5. [Ссылка на udp_scan.txt](nmap/udp_scan.txt)
